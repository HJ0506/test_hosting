...
$(document).ready(function () {
    ...
    service_list_traffic_mob +=       '<select onchange="if(this.value) location.href=(this.value);" class="combo_box">'; 
...
$(document).ready(function () {
    ...
    service_list_vacation +=                '<a href="04_개방서비스_여행·휴양_분실물 신고.html" target="_self" class="service_item_ vacation_lostReport">분실물 신고</a>'; 
...
$(document).ready(function () {
    ...
    service_list_vacation_mob +=               '<option value="04_개방서비스_여행·휴양_분실물 신고.html" class="service_option vacation_lostReport">분실물 신고</option>'; 
