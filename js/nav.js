...
header +=                                           '</li>';
header +=                                           '<li class="depth02_item">';
header +=                                               '<a href="04_개방서비스_교통_고속도로 미납통행료 조회 및 납부.html" target="_self" class="depth02_item_anchor" title="개방서비스 교통 카테고리 소개 페이지로 이동">교통</a>';
header +=                                           '</li>';
header +=                                           '<li class="depth02_item">';
header +=                                               '<a href="04_개방서비스_안전_전화권유판매 수신거부 등록.html" target="_self" class="depth02_item_anchor" title="개방서비스 안전 카테고리 소개 페이지로 이동">안전</a>';
header +=                                           '</li>';
header +=                                           '<li class="depth02_item">';
...
header +=                                           '</li>';
header +=                                           '<li class="depth02_item">';
header +=                                               '<a href="04_개방서비스_발급_건강보험자격득실확인서 발급.html" target="_self" class="depth02_item_anchor" title="개방서비스 발급 카테고리 소개 페이지로 이동">발급</a>';
header +=                                           '</li>';
header +=                                           '<li class="depth02_item">';
...
footer +=  								'<li class="list_address_item">본관: 30112 세종특별자치시 도움6로 42(어진동) <span class="only_pc_inline">/</span><br class="only_mob_inline"> 별관: 30116 세종특별자치시 가름로 143(어진동)</li>'
footer +=  								'<li class="list_address_item">문의전화: <br class="only_mob">1551-0627 (월~금 09:00~18:00 / 토, 일, 공휴일 휴무)</li>'
footer +=  						'</ul>'
